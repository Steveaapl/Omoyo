...
public class Dialog_For_Shop_Page extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Omoyo.errorReportByMint(getContext());
       ...
       switch (type_of){
           case 0:
               ...
               editText.setText(Omoyo.shared.getString(getArguments().getString("shop_id")+"message",""));
               ...
               linearLayout.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View view) {
                       if(editText.getText().toString().length()>0){
                        boolean connection =   Omoyo.isConnectingToInternet(getContext());
                           if(connection){
                               Omoyo.edit.putString(getArguments().getString("shop_id")+"message",editText.getText().toString());
                               Omoyo.edit.commit();
                               sendVarificationSms(getArguments().getString("shop_number"), editText.getText().toString());
                               alertDialog.cancel();
                           }
                           else {
                               Omoyo.toast("Internet Connection Error !",getContext());
                           }
                       }
                   }
               });
           ...
           case 7:
               ...
               linear_layout_for_dialog_child.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View view) {
                       alertDialog.cancel();
                       startActivity(new Intent(getContext(),SmsVarification.class));
                   }
               });
               break;
           case 8:
    ...
    public void saveUserSmsToServer(){
        ...
        String json=String.format("{\"user_id\" : \"%s\",\"shop_id\" : \"%s\",\"time\" : \"%s\",\"sms\" : \"%s\"}",
                Omoyo.shared.getString("user_id","1007"),
                Omoyo.currentShopId,
                Omoyo.Date()
                ,Omoyo.shared.getString(getArguments().getString("shop_id")+"message",""));
