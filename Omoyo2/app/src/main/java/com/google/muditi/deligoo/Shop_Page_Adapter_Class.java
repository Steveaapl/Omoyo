...
import com.example.muditi.deligoo.Dialog_For_Shop_Page;
...
public class Shop_Page_Adapter_Class extends RecyclerView.Adapter<Shop_Page_Adapter_Class.ViewHolder> {
    ...
    public Shop_Page_Adapter_Class(Context context , FragmentManager fragmentManager , android.support.v4.app.FragmentManager fragmentManagerSms){
        ...
        Omoyo.errorReportByMint(context);
            ...
            case 3:
                holder.circular_for_call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                            ...
                            com.google.muditi.deligoo.Dialog_For_Shop_Page dialog_for_shop_page = new com.google.muditi.deligoo.Dialog_For_Shop_Page();
                ...
                try {
                    ...
                    Glide.with(context).load(jsonObject.getString("url")).asBitmap().into(new SimpleTarget<Bitmap>() {
                        ...
                        public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                            holder.card_view_for_bitmap_of_shop.setBackgroundDrawable(new BitmapDrawable(
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private CardView card_view_for_bitmap_of_shop;
        public ViewHolder(View v) {
            ...
            card_view_for_bitmap_of_shop = ButterKnife.findById(v,R.id.card_view_for_bitmap_of_shop);
