...
public class Omoyo {
    ...
    public static  void sendMobileNumberToServer(Context context ,String user_cell_number){
        OkHttpClient okhttp=new OkHttpClient();
        String json=String.format("{\"user_id\" : \"%s\",\"user_mobile_number\" : \"%s\"}", com.example.muditi.deligoo.Omoyo.shared.getString("user_id","1007"),user_cell_number);
        final MediaType JSON=MediaType.parse("application/json;charset=utf-8");
        RequestBody requestbody=RequestBody.create(JSON, json);
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                if(response.isSuccessful()){
                    String data = response.body().string();
                    com.example.muditi.deligoo.Omoyo.edit.putBoolean("user_mobile_number_sended_to_server_successfully", true);
                    com.example.muditi.deligoo.Omoyo.edit.commit();
                }
            }
        });
    ...
    public static void checkingUserMobileSendedOrNotToServer(Context context){
        if(com.example.muditi.deligoo.Omoyo.shared.getBoolean("user_status",false)){
                         if( !com.example.muditi.deligoo.Omoyo.shared.getBoolean("user_mobile_number_sended_to_server_successfully",false)){
                               com.example.muditi.deligoo.Omoyo.sendMobileNumberToServer(context, com.example.muditi.deligoo.Omoyo.shared.getString("user_mobile_number", context.getResources().getString(R.string.welcome)));
                         }
        }
    }
    ...
    private void calculateDistance(Context context , final String shop_id){
        ...
        try {
                JSONArray jsonArray = new JSONArray(com.example.muditi.deligoo.Omoyo.shared.getString("coordinateOfShop", "coordinate"));
                ...
                builder.append("origins=" + com.example.muditi.deligoo.Omoyo.shared.getString("latitude", "41.000") + "," + com.example.muditi.deligoo.Omoyo.shared.getString("longitude", "41.0"));
                builder.append("&");
                            ...
                            try {
                                ...
                                if(jsonObject1.getString("status").equals("OK"))
                                    try {
                                        ...
                                        JSONArray jsonArray1 = new JSONArray(com.example.muditi.deligoo.Omoyo.shared.getString("distance",""));
                                        jsonArray1.put(jsonArray1.length(),putObject);
                                        com.example.muditi.deligoo.Omoyo.edit.putString("distance", jsonArray1.toString());
                                        com.example.muditi.deligoo.Omoyo.edit.commit();
    ...
    public static  void  addtofavorets(int type_of , JSONObject data){
        try {
            if (!com.example.muditi.deligoo.Omoyo.shared.contains("favorets")) {
                JSONArray jsonArray = new JSONArray();
                JSONObject jsonObject = new JSONObject();
                jsonObject.put("type_of", type_of);
                jsonObject.put("data",data);
                jsonArray.put(0, jsonObject);
                com.example.muditi.deligoo.Omoyo.edit.putString("favorets", jsonArray.toString());
                com.example.muditi.deligoo.Omoyo.edit.commit();

            } else {
                JSONArray jsonArray = new JSONArray(com.example.muditi.deligoo.Omoyo.shared.getString("favorets", ""));
                JSONObject jsonObject = new JSONObject();
                jsonObject.put("type_of", type_of);
                jsonObject.put("data",data);
    ...
    public static  void  addtoCall( JSONObject data){
        try {
            if (!com.example.muditi.deligoo.Omoyo.shared.contains("call_log")) {

                JSONArray jsonArray = new JSONArray();
                JSONObject jsonObject = new JSONObject();
                jsonObject.put("data",data);
                jsonArray.put(0, jsonObject);
                com.example.muditi.deligoo.Omoyo.edit.putString("call_log", jsonArray.toString());
                com.example.muditi.deligoo.Omoyo.edit.commit();

            } else {
                JSONArray jsonArray = new JSONArray(com.example.muditi.deligoo.Omoyo.shared.getString("call_log", ""));
                JSONObject jsonObject = new JSONObject();
                jsonObject.put("data",data);
                jsonArray.put(jsonArray.length(), jsonObject);
                com.example.muditi.deligoo.Omoyo.edit.putString("call_log", jsonArray.toString());
    ...
    public static  void  addtoSms(JSONObject data){
        try {
            if (!com.example.muditi.deligoo.Omoyo.shared.contains("sms_log")) {
                ...
                JSONArray jsonArray = new JSONArray(com.example.muditi.deligoo.Omoyo.shared.getString("sms_log", ""));
                JSONObject jsonObject = new JSONObject();
