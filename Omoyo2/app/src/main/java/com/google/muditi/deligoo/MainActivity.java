...
import com.example.muditi.deligoo.Log_Activity;
import com.example.muditi.deligoo.SearchDataInsert;
...
import com.example.muditi.deligoo.subshopcategory;
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch(id){
                    ...
                    case R.id.favourites:
                        ...
                        break;
                    case R.id.call_log:
                        Intent intent5 = new Intent(getApplicationContext(), com.example.muditi.deligoo.Log_Activity.class);
                        intent5.putExtra("type_of",0);
                        startActivity(intent5);
                        break;
                    case R.id.message_log:
                        Intent intent3 = new Intent(getApplicationContext(), com.example.muditi.deligoo.Log_Activity.class);
