...
import com.example.muditi.deligoo.MapFragmentForAddress;
 ...
 */
public class shoppageadapter extends RecyclerView.Adapter<com.example.muditi.deligoo.shoppageadapter.CustomViewHolder>{
    Context context;
    String[] textdata;
    ...
    @Override
    public com.example.muditi.deligoo.shoppageadapter.CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(com.example.muditi.deligoo.shoppageadapter.CustomViewHolder viewHolder, int i) {
